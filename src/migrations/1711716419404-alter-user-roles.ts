...
export class AlterUserRoles1711716419404 implements MigrationInterface {
  name = 'AlterUserRoles1711716419404';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            CREATE TYPE "public"."user_role_enum" AS ENUM('customer', 'helpsupport', 'superadmin')
        `);
    await queryRunner.query(`
            ALTER TABLE "user"
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TYPE "public"."user_role_enum_old" AS ENUM('customer', 'admin', 'superadmin')
        `);
    await queryRunner.query(`
            ALTER TABLE "user"
            ALTER COLUMN "role" DROP DEFAULT
